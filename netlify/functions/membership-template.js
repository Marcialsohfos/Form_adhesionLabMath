...
// Configuration Supabase - LES VARIABLES SERONT REMPLACÉES ICI
const supabaseUrl = "${https://fbwfollnqdavorcvizxq.supabase.co}";
const supabaseServiceKey = "${sb_secret_Sm7BUoW9CKDGRzX_5LHxNQ_RmeejInq}";
